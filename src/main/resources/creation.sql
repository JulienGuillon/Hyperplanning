...
INSERT INTO COURSE(typeCourse, hour, date, subject, duree, teacher, idRoom) VALUES ('CM', 8, '2015-11-02', 'MATH', 1, 'jguillon725', 2);
INSERT INTO COURSE(typeCourse, hour, date, subject, duree, teacher, idRoom) VALUES ('TP', 14, '2015-11-02', 'C', 3, 'jguillon725', 3);
INSERT INTO COURSE(typeCourse, hour, date, subject, duree, teacher, idRoom) VALUES ('TD', 10, '2015-11-04', 'JAVA', 2, 'jguillon725', 1);
INSERT INTO COURSE(typeCourse, hour, date, subject, duree, teacher, idRoom) VALUES ('TP', 13, '2015-10-27', 'JAVA', 3, 'jguillon725', 1);

INSERT INTO CoursePromotion VALUES (1, 1);
INSERT INTO CoursePromotion VALUES (4, 1);
...
CREATE VIEW VIEWCOURSEPROMOTION AS
  SELECT CoursePromotion.idPromotion, typeCourse, hour, date, subject, duree, teacher, idRoom
  FROM CoursePromotion, COURSE
  WHERE idCoursePromotion = idCourse;

CREATE VIEW VIEWCOURSEGROUP AS
  SELECT CourseGroup.idGroup, typeCourse, hour, date, subject, duree, teacher, idRoom
