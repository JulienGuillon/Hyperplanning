...
CREATE TABLE USERS(
  nom VARCHAR(100) REFERENCES PERSON(nom) UNIQUE ,
  role Roles REFERENCES PERSON(role) UNIQUE,
  login VARCHAR(100),
...
CREATE TABLE STUDENT(
  nom VARCHAR(100) REFERENCES USERS(nom) UNIQUE ,
  role Roles REFERENCES PERSON(role) UNIQUE,
  login VARCHAR(100) REFERENCES USERS(login),
  password VARCHAR(100) REFERENCES USERS(password),
...
CREATE TABLE PROMOTION(
  ...
  PRIMARY KEY (typePromotion, domainePromotion, anneePromotion)
);

INSERT INTO PROMOTION VALUES ('M1', 'SI', 2015, 200);
INSERT INTO PROMOTION VALUES ('L1', 'BIO', 2015, 200);
INSERT INTO PROMOTION VALUES ('L1', 'SI', 2015, 200);
INSERT INTO PROMOTION VALUES ('L2', 'SI', 2015, 200);
...
INSERT INTO ROOM VALUES ('A', 1, 'TP', 30);
INSERT INTO ROOM VALUES ('A', 2, 'TP', 30);
INSERT INTO ROOM VALUES ('B',1, 'Amphi', 100);
INSERT INTO ROOM VALUES ('B', 2, 'TP', 30);
